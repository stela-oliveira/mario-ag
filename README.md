...
### Construir a imagem (só na primeira vez)
...
> O treino salva automaticamente a cada geração em `populations/mario1.json`.
> Se fechar e abrir novamente com o **mesmo nome**, continua de onde parou.
